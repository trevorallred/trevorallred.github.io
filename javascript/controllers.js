...
controllers.controller('whatController', ['$scope', '$routeParams', 'resume_data', function ($scope, $routeParams, resume_data) {
    var wheres = resume_data.data.where;
    var whats = resume_data.data.what;
    for(var key in wheres) {
        if (wheres.hasOwnProperty(key)) {
...
controllers.controller('howController', ['$scope', '$routeParams', 'resume_data', function ($scope, $routeParams, resume_data) {
    var wheres = resume_data.data.where;
    var whats = resume_data.data.what;
    for(var key in wheres) {
        if (wheres.hasOwnProperty(key)) {
